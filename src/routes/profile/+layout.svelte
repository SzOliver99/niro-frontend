<script>
	...
	const list = $state([
		{ href: '/profile', title: 'Account', icon: FileUser },
		{ href: '/profile/security', title: 'Security', icon: Lock }
	]);
...
<section>
	{#if loggedIn}
		...
		>
			<h1 class="mb-4 text-2xl font-bold">Account Information</h1>
			<div class="rounded-lg shadow-lg ring">
				<div class="flex h-full justify-between border-b py-2 *:font-medium">
